...
replace (
	...
	k8s.io/code-generator => k8s.io/code-generator v0.0.0-20190416052311-01a054e913a9
)

replace k8s.io/component-base => k8s.io/component-base v0.0.0-20190416053005-dfaf58e38083
