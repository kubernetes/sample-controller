...
* How to register a new custom resource (custom resource type) of type `SessionJob` using a CustomResourceDefinition.
* How to create/get/list instances of your new resource type `SessionJob`.
